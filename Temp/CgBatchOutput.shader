...
void main ()
{
  ...
  lowp vec4 c_i0;
  c_i0.xyz = ((tmpvar_1.xyz * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, _WorldSpaceLightPos0.xyz)) * 2.0));
  c_i0.w = tmpvar_1.w;
  c = c_i0;
...
adaaaaaaabaaapacaaaaaaoeacaaaaaaahaaaaoeaeaaaaaa mul r1, r0, v7
...
void main ()
{
  ...
  lowp vec4 c_i0;
  c_i0.xyz = ((tmpvar_1.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir)) * texture2D (_LightTexture0, tmpvar_3).w) * 2.0));
  c_i0.w = tmpvar_1.w;
  c = c_i0;
  c.w = tmpvar_1.w;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lowp vec4 c_i0;
  c_i0.xyz = ((tmpvar_1.xyz * _LightColor0.xyz) * (max (0.0, dot (xlv_TEXCOORD1, lightDir)) * 2.0));
  c_i0.w = tmpvar_1.w;
  c = c_i0;
  c.w = tmpvar_1.w;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lowp vec4 c_i0;
  c_i0.xyz = ((tmpvar_1.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir)) * atten) * 2.0));
  c_i0.w = tmpvar_1.w;
  c = c_i0;
  c.w = tmpvar_1.w;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_3 = vec2(dot (xlv_TEXCOORD3, xlv_TEXCOORD3));
  lowp vec4 c_i0;
  c_i0.xyz = ((tmpvar_1.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir)) * (texture2D (_LightTextureB0, tmpvar_3).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_i0.w = tmpvar_1.w;
  c = c_i0;
  c.w = tmpvar_1.w;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lightDir = xlv_TEXCOORD2;
  lowp vec4 c_i0;
  c_i0.xyz = ((tmpvar_1.xyz * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir)) * texture2D (_LightTexture0, xlv_TEXCOORD3).w) * 2.0));
  c_i0.w = tmpvar_1.w;
  c = c_i0;
  c.w = tmpvar_1.w;
  gl_FragData[0] = c;
...
MUL R2, R2, fragment.color.primary;
